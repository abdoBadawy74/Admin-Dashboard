            ...
            <div className="flex p-4  flex-wrap">
                ...
                <div className="basis-full md:basis-2/3 p-4">
                    ...
                    <div className="mt-12">
                        ...
                        <div className="flex gap-4 flex-wrap md:flex-nowrap">
                            <div className="basis-full md:basis-1/2">
                                <p className="text-[#344054] my-2">  المؤهل  </p>
                                <p className="border  p-2 rounded-lg font-medium">كلبة الحقوق جامعة الملك سعود </p>
                            </div>

                            <div className="basis-full md:basis-1/2">
                                <p className="text-[#344054] my-2">  الخبرات    </p>
                                <p className="border  p-2 rounded-lg font-medium"> 5 سنوات في الاستشارت </p>
                            </div>
                        </div>

                        <div className="flex gap-4 flex-wrap md:flex-nowrap">
                            <div className="basis-full md:basis-1/2">
                                <p className="text-[#344054] my-2">  الشهادات  </p>
                                <p className="border  p-2 rounded-lg font-medium">حاصل علي ماجستير في ادارة الاعمال  </p>
                            </div>

                            <div className="basis-full md:basis-1/2">
                                <p className="text-[#344054] my-2">  سعر الاستشارة   </p>
                                <p className="border  p-2 rounded-lg font-medium"> 50 ر.س</p>
                            </div>
                        </div>
                    </div>
                </div>
